                ...
                <div className="grid gap-1 grid-cols-2">
                  <div>
                    ...
                    <div className="mt-4">
                      ...
                      <p className="mt-1">
                      <span
                        className={classNames(USER_STATUS_CLASS_MAP[user.status], 'p-1 rounded')}>{USER_STATUS_TEXT_MAP[user.status]}</span>
                      </p>
                    </div>
                    <div className="mt-4">
          ...
          <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
              <div className="p-6 text-gray-900 dark:text-grey-100">
                ...
                <TasksTable user={user} fromUserShow={true} tasks={tasks} queryParams={queryParams}/>
              </div>
            </div>
          </div>
        </div>
